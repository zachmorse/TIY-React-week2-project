const lensesData = [
  {
    ...
    picture: require("../images/Leica-lens.jpg"),
    price: "$1,895.00",
    description:
      "For Leica T users who want a far-reaching telephoto perspective comes the APO-Vario-Elmar-T 55-135mm f/3.5-4.5 ASPH Lens from Leica with an 80-200mm equivalent focal length. The lens features an aperture range of f/3.5-4.5 to f/16 as well as an aspherical element to keep the lens design compact. The element also controls distortion and reduces the impact of aberrations. Additionally, the lens has an autofocus motor, which can be overridden for when manual focus is desired."
  },
  {
    id: 2,
